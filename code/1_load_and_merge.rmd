...
WT_NT_Adult_1 %<-% {runSoupX(Read10X("./data/WT_adult/raw_feature_bc_matrix JS5")$`Gene Expression`,
                             Read10X("./data/WT_adult/filtered_feature_bc_matrix JS5")$`Gene Expression`,
                                 "./data/seq/WT_NT_Adult_1/soupx_counts/",
                                 "WT_NT_Adult_1") %>%
        PercentageFeatureSet(., pattern = "^mt-", col.name = "percent.mt") %>%
        subset(., subset = percent.mt < pct_mt_high & percent.mt > pct_mt_low & nFeature_RNA > min_nfeature)}

WT_NT_Adult_2 %<-% {runSoupX(Read10X("./data/WT_adult/raw_feature_bc_matrix JS-11 P64")$`Gene Expression`,
                             Read10X("./data/WT_adult/filtered_feature_bc_matrix JS11 P64-2")$`Gene Expression`,
                                 "./data/seq/WT_NT_Adult_2/soupx_counts/",
                                 "WT_NT_Adult_2") %>%
        PercentageFeatureSet(., pattern = "^mt-", col.name = "percent.mt") %>%
        subset(., subset = percent.mt < pct_mt_high & percent.mt > pct_mt_low & nFeature_RNA > min_nfeature)}

WT_LPS_Adult_1 %<-% {runSoupX(Read10X("./data/b1/EP2_WT_Cd45neg_LPS/raw_feature_bc_matrix")$`Gene Expression`,
                              Read10X("./data/b1/EP2_WT_Cd45neg_LPS/filtered_feature_bc_matrix")$`Gene Expression`,
                                  "./data/seq/WT_LPS_Adult_1/soupx_counts/",
                                  "WT_LPS_Adult_1") %>%
        PercentageFeatureSet(., pattern = "^mt-", col.name = "percent.mt") %>%
        subset(., subset = percent.mt < pct_mt_high & percent.mt > pct_mt_low & nFeature_RNA > min_nfeature)}


B1_NT_Adult_1 %<-% {runSoupX(Read10X("./data/b1/EP4_B1_P7_CD45neg/raw_feature_bc_matrix")$`Gene Expression`,
                             Read10X("./data/b1/EP4_B1_P7_CD45neg/filtered_feature_bc_matrix")$`Gene Expression`,
                                 "./data/seq/B1_NT_Adult_1/soupx_counts/",
                                 "B1_NT_Adult_1") %>%
        PercentageFeatureSet(., pattern = "^mt-", col.name = "percent.mt") %>%
        subset(., subset = percent.mt < pct_mt_high & percent.mt > pct_mt_low & nFeature_RNA > min_nfeature)}


B1_LPS_Adult_1 %<-% {runSoupX(Read10X("./data/b1/EP6_B1_P7_CD45neg_LPS/raw_feature_bc_matrix")$`Gene Expression`,
                             Read10X("./data/b1/EP6_B1_P7_CD45neg_LPS/filtered_feature_bc_matrix")$`Gene Expression`,
                             "./data/seq/B1_LPS_Adult_1/soupx_counts/",
                             "B1_LPS_Adult_1") %>%
        PercentageFeatureSet(., pattern = "^mt-", col.name = "percent.mt") %>%
        subset(., subset = percent.mt < pct_mt_high & percent.mt > pct_mt_low & nFeature_RNA > min_nfeature)}
...
expression_objs_no_Cd45 <- list(
  WT_NT_Adult_1 = WT_NT_Adult_1,
  WT_NT_Adult_2 = WT_NT_Adult_2,
  WT_LPS_Adult_1 = WT_LPS_Adult_1,
  B1_NT_Adult_1 = B1_NT_Adult_1,
  B1_LPS_Adult_1 = B1_LPS_Adult_1
)
```
...
antibody_dat <- list(
  WT_NT_Adult_1 = Read10X("./data/WT_adult/filtered_feature_bc_matrix JS5")$`Antibody Capture`,
  WT_NT_Adult_2 = Read10X("./data/WT_adult/filtered_feature_bc_matrix JS11 P64-2")$`Antibody Capture`,
  WT_LPS_Adult_1 = Read10X("./data/b1/EP2_WT_Cd45neg_LPS/filtered_feature_bc_matrix")$`Antibody Capture`,
  B1_NT_Adult_1 = Read10X("./data/b1/EP4_B1_P7_CD45neg/filtered_feature_bc_matrix")$`Antibody Capture`,
  B1_LPS_Adult_1 = Read10X("./data/b1/EP6_B1_P7_CD45neg_LPS/filtered_feature_bc_matrix")$`Antibody Capture`
)
...
ab_list <- list(
  WT_NT_Adult_1 = mouse_ab_names[1:4],
  WT_NT_Adult_2 = mouse_ab_names[1:4],
  WT_LPS_Adult_1 = mouse_ab_names[3:5],
  B1_NT_Adult_1 = mouse_ab_names[1:3],
  B1_LPS_Adult_1 = mouse_ab_names[3:5]
)

sex_mapping <- list(
  WT_NT_Adult_1 = c("F", "F", "M", "M"),
  WT_NT_Adult_2 = c("F", "F", "M", "M"),
  WT_LPS_Adult_1 = c("F", "F", "F"),
  B1_NT_Adult_1 = c("F", "M", "M"),
  B1_LPS_Adult_1 = c("M", "M", "M")
)
...
EP_LPS_data$injury <- sapply(str_split(EP_LPS_data$orig.ident, "_"), function(x){x[2]})
EP_LPS_data$timepoint <- sapply(str_split(EP_LPS_data$orig.ident, "_"), function(x){x[3]})

saveRDS(EP_LPS_data, "./data/b1/b1_noCd45_merged.rds", compress = "bzip2")
```
...
```{r}
saveRDS(EP_LPS_data, "./data/b1/b1_noCd45_sct.rds", compress = "bzip2")
```
