...
pathway_data_lps <- read_tsv("./B1_LPS_v4_no_7639/IPA/D21_AT2_xfer_LPS_B1_vs_WT.txt", skip = 1)
...
ggsave("./data/b1/figures/D21_IPA_heatmap_LPS_iKO_vs_WT_up_AT2.pdf", pathway_heatmap_plot_lps_up)
...
ggsave("./data/b1/figures/D21_IPA_heatmap_LPS_iKO_vs_WT_down_AT2.pdf", pathway_heatmap_plot_lps_down)
...
pathway_data_lps <- read_tsv("./B1_LPS_v4_no_7639/IPA/D21_AT2MERGE_xfer_LPS_B1_vs_WT.txt", skip = 1)
top10_pathways_lps_up <- pathway_data_lps %>% arrange('-log(p-value)') %>% filter(`z-score` > 0) %>% head(8)
plot_order_lps_up <- unique(top10_pathways_lps_up$`Ingenuity Canonical Pathways`)
...
ggsave("./data/b1/figures/D21_IPA_heatmap_LPS_iKO_vs_WT_up_AT2_w_activated.pdf", pathway_heatmap_plot_lps_up)
...
ggsave("./data/b1/figures/D21_IPA_heatmap_LPS_iKO_vs_WT_down_AT2_w_activated.pdf", pathway_heatmap_plot_lps_down)
